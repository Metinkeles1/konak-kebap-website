...
import { forwardRef, type CSSProperties, type ButtonHTMLAttributes, type ReactNode } from 'react';
  ...
  (
    ...
    return (
      <button
        ...
        className={cn(
          'group relative z-0 flex cursor-pointer items-center justify-center overflow-hidden whitespace-nowrap border border-white/10 px-6 py-3 text-black font-medium [background:var(--bg)] [border-radius:var(--radius)] transition-transform active:translate-y-px',
          'hover:shadow-[0_4px_30px_rgba(201,168,76,0.4)]',
          className
        )}
        ref={ref}
        {...props}
